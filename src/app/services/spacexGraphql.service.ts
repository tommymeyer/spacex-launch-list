...
export type PastLaunchesDetailsQueryVariables = {
  id: Scalars['ID'];
};


export type PastLaunchesDetailsQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const PastLaunchesDetailsDocument = gql`
    query pastLaunchesDetails($id: ID!) {
  launch(id: $id) {
    id
    mission_name
    details
  ...
  export class PastLaunchesDetailsGQL extends Apollo.Query<PastLaunchesDetailsQuery, PastLaunchesDetailsQueryVariables> {
    document = PastLaunchesDetailsDocument;
  }
